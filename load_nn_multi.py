...
parametersFileDir = "./data/parameters_mfcc_5.pkl"
relativePathForTest = "./data/melfilter48/test_clear_multi/"
...
#n_hidden_4 = 256
#n_hidden_5 = 128
n_input = 64 # input dimensionality
		...
		for root, dirs, files in os.walk(relativePathForTest, topdown=False):
			...
			for name in dirs:
				...
				for part in parts:
					...
					#predicted_class.append(product)
					...
					ind += 1
				gt += 1
		#print(list_predicted_class)
		#print(list_actual_class)
		accuracy_multi = 0
		recall = 0
		precision = 0
		hamming_loss = 0
