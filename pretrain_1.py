...
train_X = np.copy(train[:,:-2]) # Access all but except the last two column
...
# test_y = dense_to_multi_hot(test_labels_dense, num_classes = n_classes)
...
# n_hidden_3 = 256
n_input = 64 # input dimensionality(585)
